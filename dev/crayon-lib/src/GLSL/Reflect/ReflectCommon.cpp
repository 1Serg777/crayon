...
namespace crayon {
	...
	static std::unordered_map<TokenType, VertexAttribType> tokenTypeToVertexAttribTypeMap = {
		{TokenType::INT,   VertexAttribType::INT32  },
		{TokenType::UINT,  VertexAttribType::UINT32 },
		{TokenType::FLOAT, VertexAttribType::FLOAT32},
	};
	static std::unordered_map<VertexAttribType, TokenType> vertexAttribTypeToTokenTypeMap = {
		{VertexAttribType::INT32  , TokenType::INT  },
		{VertexAttribType::UINT32 , TokenType::UINT },
		{VertexAttribType::FLOAT32, TokenType::FLOAT},
	};
	VertexAttribType TokenTypeToVertexAttribType(TokenType tokenType) {
			TokenType fundType = GetFundamentalType(tokenType);
			auto searchRes = tokenTypeToVertexAttribTypeMap.find(fundType);
	...
	static std::unordered_map<TokenType, ColorAttachmentType> tokenTypeToColorAttachmentTypeMap = {
		{TokenType::INT,   ColorAttachmentType::INT  },
		{TokenType::UINT,  ColorAttachmentType::UINT },
		{TokenType::FLOAT, ColorAttachmentType::FLOAT},
		{TokenType::IVEC2, ColorAttachmentType::IVEC2},
		{TokenType::IVEC3, ColorAttachmentType::IVEC3},
		{TokenType::IVEC4, ColorAttachmentType::IVEC4},
		{TokenType::UVEC2, ColorAttachmentType::UVEC2},
		{TokenType::UVEC3, ColorAttachmentType::UVEC3},
		{TokenType::UVEC4, ColorAttachmentType::UVEC4},
		{TokenType::VEC2,  ColorAttachmentType::VEC2 },
		{TokenType::VEC3,  ColorAttachmentType::VEC3 },
		{TokenType::VEC4,  ColorAttachmentType::VEC4 },
	};
	static std::unordered_map<ColorAttachmentType, TokenType> colorAttachmentTypeToTokenTypeMap = {
		{ColorAttachmentType::INT,   TokenType::INT  },
		{ColorAttachmentType::UINT,  TokenType::UINT },
		{ColorAttachmentType::FLOAT, TokenType::FLOAT},
		{ColorAttachmentType::IVEC2, TokenType::IVEC2},
		{ColorAttachmentType::IVEC3, TokenType::IVEC3},
		{ColorAttachmentType::IVEC4, TokenType::IVEC4},
		{ColorAttachmentType::UVEC2, TokenType::UVEC2},
		{ColorAttachmentType::UVEC3, TokenType::UVEC3},
		{ColorAttachmentType::UVEC4, TokenType::UVEC4},
		{ColorAttachmentType::VEC2,  TokenType::VEC2 },
		{ColorAttachmentType::VEC3,  TokenType::VEC3 },
		{ColorAttachmentType::VEC4,  TokenType::VEC4 },
	};
	ColorAttachmentType TokenTypeToColorAttachmentType(TokenType tokenType) {
			auto searchRes = tokenTypeToColorAttachmentTypeMap.find(tokenType);
